										...
										<TABLE cellSpacing=0 cellPadding=2 border=0>
											<TBODY>
												<TR>
													<TD>客户名称：</TD>
													<TD>
														<input type="hidden" name="customer.cust_id" id="c_id" value="${param['customer.cust_id']}" />
														<INPUT class=textbox style="WIDTH: 80px" maxLength=50 name="cust_name"  id="c_name" value="${param['cust_name']}" >
									...
									<TD>
										<TABLE id=grid
											...
											<TBODY>
												...
												<s:iterator value="#pageBean.pageBean" >
												<TR
