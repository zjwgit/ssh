					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							...
							<TR>
								<td>所属客户：</td>
								<td >
								<input type="hidden" name="customer.cust_id" style="WIDTH: 180px" id="c_id" value="<s:property value="#saleVisit.customer.cust_id" />" />
								<input type="text"  style="WIDTH: 180px" id="c_name" value="<s:property value="#saleVisit.customer.cust_name" />"/>
									<input type="button" value="选择客户" onclick="window.open('${pageContext.request.contextPath}/CustomerAction_list?select=true','请选择客户','width=500,height=400,location=no,left=500px,top=200px')" />
								</td>
								<td>拜访时间 ：</td>
								<td  >
