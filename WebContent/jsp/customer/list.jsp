...
<SCRIPT language=javascript>
    ...
    function setParent(pname,pid) {
		var win	= window.opener;
		var document =  win.document;
		document.getElementById("c_name").value=pname;
									...
									<TD>
										<TABLE id=grid
											...
											<TBODY>
												...
												<s:iterator value="#pagebean.pageBean"  var="cust" >
												<TR 		
													...
													<s:else>
														...
														<td><s:property value="#cust.cust_name"></s:property>
															<input type="button" value="选择" onclick="setParent('<s:property value="#cust.cust_name"></s:property>',<s:property value="#cust.cust_id"></s:property>)">
														</td>
													</s:else>
												</TR>
												</s:iterator>
