					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							<tr>
								<td>所属客户：</td>
								<td>
									<input type="hidden" name="customer.cust_id" id="c_id" value="<s:property value="#linkman.customer.cust_id"/>">
									<input type="text" id="c_name" value="<s:property value="#linkman.customer.cust_name"/>">
								</td>
								<td>
